...
def transform_to_glove(date_from, date_to, filename, forum_id, max_df, min_df, vec_dim, window_size, niter):
...
def build_glove_word_vectors(data_frame, vec_dim, vectorizer, window_size, niter):
